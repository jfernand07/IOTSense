...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Token de acceso emitido.' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Refrescar token' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Nuevo token generado.' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
